...
<div class="notice-icon"><img src="https://www.google.com/s2/favicons?domain=x.com&sz=128" alt="" class="notice-favicon" /></div>
<div class="notice-body">
<h3>即将离开 AI工具导航</h3>
<p>您正在访问 <strong>x.com</strong></p>
<p class="notice-desc">我们已对目标网站进行基础审核，但不对其内容和服务负责。</p>
</div>
<div class="notice-btn">
<a href="https://x.com/i/grok" target="_blank" rel="noopener noreferrer" class="btn-confirm">确认访问 →</a>

...
export const tools = [
  ...
  // ===== 第四批新增工具 =====
  { id: 'coze', name: 'Coze扣子', desc: '字节跳动推出的AI Bot开发平台，无需编程即可通过拖拽方式创建聊天机器人和工作流，支持接入ChatGPT、Claude、通义千问等多模型，内置丰富插件生态，可一键发布到抖音、飞书、微信等多个平台。', cat: 'chatbot', url: 'https://www.coze.cn', tag: '免费', tags: ['Bot创建', '工作流', '多平台发布'] },
  { id: 'trae', name: 'Trae', desc: '字节跳动推出的AI编程工具，基于GPT-4o和Claude模型，支持代码生成、Debug调试和项目级问答，内置中文界面和即时响应，免费版功能全面，是国内开发者的Copilot免费替代选择。', cat: 'chatbot', url: 'https://www.trae.ai', tag: '免费', tags: ['AI编程', '中文界面', '免费'] },
  { id: 'manus', name: 'Manus', desc: 'AI Agent平台，能自主完成复杂多步骤任务如数据分析、报告生成、简历筛选等，基于多个专业AI模型协同工作，注册后有免费体验额度，代表了AI从工具向智能助手演进的方向。', cat: 'chatbot', url: 'https://manus.im', tag: '免费试用', tags: ['AI Agent', '任务自动化', '多步骤工作'] },
  { id: 'zhipu', name: '智谱GLM-4', desc: '智谱AI推出的GLM-4大模型，支持多模态理解、长文本和代码生成，提供在线对话和API服务，GLM-4V在视觉理解方面表现优异，国产大模型中技术积累最深、开放程度最高的平台之一。', cat: 'chatbot', url: 'https://www.zhipuai.cn', tag: '免费额度', tags: ['多模态', 'API开放', '国产'] },
  { id: 'openrouter', name: 'OpenRouter', desc: 'AI模型聚合网关，一站接入GPT-4、Claude、Llama、Mistral等数十种模型，支持模型对比和自动路由选择，按使用量计费无需订阅，提供API和统一接口，开发者切换模型的便捷平台。', cat: 'chatbot', url: 'https://openrouter.ai', tag: '免费额度', tags: ['多模型聚合', 'API网关', '按量计费'] },
  { id: 'recraft', name: 'Recraft', desc: 'AI图像生成工具，专注于矢量插画和品牌设计，支持生成一致风格的系列图片，提供可编辑的SVG格式输出，设计师可精调颜色、布局和细节，Brand Kit功能帮助企业建立统一的视觉语言。', cat: 'image', url: 'https://www.recraft.ai', tag: '免费试用', tags: ['矢量图', '品牌设计', 'SVG导出'] },
  { id: 'pixlr', name: 'Pixlr', desc: '在线AI图片编辑器，提供AI抠图、背景替换、图像增强和批量处理功能，界面类似Photoshop但更轻量，支持网页和移动端，免费功能丰富，摄影爱好者和电商卖家处理图片的实用工具。', cat: 'image', url: 'https://pixlr.com', tag: '免费', tags: ['在线修图', 'AI抠图', '批量处理'] },
  { id: 'pixelcut', name: 'Pixelcut', desc: 'AI图片编辑工具，专注电商场景，提供AI背景移除、商品图增强、批量尺寸调整和一键生成多种尺寸适配不同平台，支持Canva导出，适合亚马逊、Shopify等电商平台卖家快速制作产品图。', cat: 'image', url: 'https://pixelcut.ai', tag: '免费', tags: ['电商修图', '批量处理', '多平台适配'] },
  { id: 'photopea', name: 'Photopea', desc: '网页版Photoshop，完全免费无需安装，支持PSD、AI、Sketch等格式文件的编辑，提供图层、蒙版、滤镜等完整功能，与Photoshop操作习惯一致，是临时修图和轻量设计的理想选择。', cat: 'image', url: 'https://www.photopea.com', tag: '免费', tags: ['网页PS', 'PSD编辑', '免安装'] },
  { id: 'vanceai', name: 'Vance AI', desc: 'AI图片增强与修复工具，支持图片无损放大（最高16倍）、去噪、锐化和老照片修复，采用深度学习模型保留细节，适合摄影师放大作品、修复珍贵旧照和提升图片质量，免费额度充足。', cat: 'image', url: 'https://vanceai.com', tag: '免费额度', tags: ['图片放大', '老照片修复', '去噪'] },
  { id: 'palettfm', name: 'Palette FM', desc: 'AI图片调色和上色工具，基于深度学习自动识别图像内容并推荐最佳配色方案，支持一键上色、风格迁移和灰度图着色，每日免费处理次数充足，设计师和摄影师快速调色的效率工具。', cat: 'image', url: 'https://palette.fm', tag: '免费', tags: ['AI调色', '风格迁移', '上色'] },
  { id: 'leiapix', name: 'LeiaPix', desc: '将普通照片转换为3D光效动画的工具，基于 Leia 的光场技术生成深度图，支持平滑动画、 Parallax 视差和 GIF 输出，一键让静态照片获得立体感，适合社交媒体和数字营销内容创作。', cat: 'image', url: 'https://www.leiapix.com', tag: '免费', tags: ['3D效果', '光场技术', 'GIF动画'] },
  { id: 'domo-ai', name: 'Domo AI', desc: 'AI视频生成和风格转换工具，支持将视频转换为不同艺术风格（如动漫、皮克斯、3D渲染），提供视频延长和角色一致性保持功能，生成的视频可用于社交媒体内容创作，操作直观简单。', cat: 'video', url: 'https://domoai.app', tag: '免费试用', tags: ['风格转换', '视频生成', '社交媒体'] },
  { id: 'wanxing', name: '万兴播爆', desc: '万兴科技推出的AI数字人视频生成平台，输入文案即可生成逼真的数字人播报视频，提供多肤色、多语言的数字人形象，支持PPT一键转视频和背景模板，适合跨境电商、企业培训和营销视频制作。', cat: 'video', url: 'https://virbo.wondershare.cn', tag: '免费试用', tags: ['数字人', 'PPT转视频', '跨境电商'] },
  { id: 'opus-clip', name: 'Opus Clip', desc: 'AI视频剪辑工具，自动将长视频（如YouTube、播客）拆分为多个精彩短视频片段，AI识别高光时刻、添加字幕和动态缩放效果，一键生成适合TikTok、Instagram Reels、YouTube Shorts的竖版短视频。', cat: 'video', url: 'https://opus.pro', tag: '免费试用', tags: ['视频拆条', 'AI剪辑', '社交短视频'] },
  { id: 'deskreen', name: 'Deskreen', desc: '将任何窗口或屏幕实时无线投屏到浏览器的工具，支持多设备同时查看，适合远程协助、在线教育和会议演示，无需安装额外软件只需扫码即可连接，保护隐私的同时实现便捷投屏体验。', cat: 'video', url: 'https://deskreen.com', tag: '免费开源', tags: ['无线投屏', '多设备', '远程协助'] },
  { id: 'lark', name: '飞书', desc: '字节跳动推出的企业协作平台，集成即时通讯、在线文档、视频会议、项目管理和多维表格等功能，内置飞书AI助手支持智能总结、翻译润色和会议纪要自动生成，审批和工作流自动化完善，中小团队首选。', cat: 'office', url: 'https://www.feishu.cn', tag: '免费额度', tags: ['团队协作', '在线文档', 'AI助手'] },
  { id: 'noteyibo', name: '有道云笔记AI', desc: '网易有道云笔记内置AI功能，支持智能写作辅助、OCR文字识别、文档翻译和语音速记，多端实时同步，Markdown和富文本双模式编辑，知识库管理和智能标签分类，适合个人知识管理和团队协作。', cat: 'office', url: 'https://note.youdao.com', tag: '免费', tags: ['笔记管理', 'OCR识别', '多端同步'] },
  { id: 'onenote', name: 'OneNote', desc: '微软免费数字笔记本，采用无限画布式布局，支持手写、语音、图片、网页剪辑等多种输入方式，与Microsoft 365深度集成提供AI分析功能，强大的组织结构适合做个人知识库和项目笔记管理。', cat: 'office', url: 'https://www.onenote.com', tag: '免费', tags: ['无限画布', '手写笔记', '微软生态'] },
  { id: 'trello', name: 'Trello', desc: '看板式项目管理工具，通过卡片和面板管理任务和项目进展，支持自动化工作流（Butler）和Power-Up插件扩展，免费版功能完整，与Slack、Google Drive等工具集成，适合敏捷团队和个人任务管理。', cat: 'office', url: 'https://trello.com', tag: '免费额度', tags: ['看板管理', '敏捷', '自动化'] },
  { id: 'suno-api', name: 'Suno API', desc: 'Suno音乐生成平台提供API接口，开发者可将AI音乐生成能力集成到自己的应用中，支持多风格音乐生成和歌词控制，适合音乐应用、游戏音效和内容创作平台集成，专业开发者使用。', cat: 'audio', url: 'https://suno.ai', tag: '付费', tags: ['音乐API', '开发者集成', '多风格'] },
  { id: 'mazwai', name: 'MazWai', desc: '免费高画质视频素材库，收录大量实拍短视频片段用于商业项目，覆盖自然、城市、人物等多种类别，下载无需注册署名，CC0协议可商用无版权风险，视频创作者寻找素材的实用工具。', cat: 'audio', url: 'https://mazwai.com', tag: '免费', tags: ['视频素材', '商用免费', '无版权'] },
  { id: 'pixabay-music', name: 'Pixabay音乐', desc: 'Pixabay旗下免费音乐和音效素材库，数千首CC0协议音乐可免费下载商用，涵盖欢快、舒缓、紧张等多种情绪，覆盖视频配音、广告配乐和游戏音效等场景，一站式解决视频背景音乐需求。', cat: 'audio', url: 'https://pixabay.com/music', tag: '免费', tags: ['免费音乐', '商用无版权', '多风格'] },
  { id: 'freesound', name: 'FreeSound', desc: '开放音频社区平台，汇集全球用户上传的音效和采样片段，支持按声音类型、时长、采样率筛选，基于CC协议分享，开发者可通过API获取音频，适合游戏开发、影视制作和声音设计爱好者。', cat: 'audio', url: 'https://freesound.org', tag: '免费', tags: ['音效素材', '社区', 'API'] },
  { id: 'ungzip', name: '解压缩工具', desc: 'Windows全能解压缩工具，支持RAR、ZIP、7Z等40多种格式，中文界面简洁无广告，提供分卷压缩、密码保护右键菜单集成和文件预览功能，绿色免安装版适合临时使用，系统维护和日常办公必备。', cat: 'system', url: 'https://www.ungzip.com', tag: '免费', tags: ['多格式', '右键集成', '分卷压缩'] },
  { id: 'dism', name: 'Dism++', desc: 'Windows系统优化和维护工具，提供系统更新管理、启动项清理、存储感知和系统还原功能，基于微软DISM/BCD等底层接口开发，体积小巧功能强大，可替代系统自带工具进行深度系统维护和清理。', cat: 'system', url: 'https://www.chuyu.me', tag: '免费', tags: ['系统维护', '启动项', '存储清理'] },
  { id: 'rufus', name: 'Rufus', desc: '制作USB启动盘的工具，支持Windows、Linux各发行版和WinPE镜像写入，提供BIOS/UEFI启动选项和分区方案，可制作Windows To Go便携环境，体积仅1MB完全免费，系统重装和U盘启动的必备工具。', cat: 'system', url: 'https://rufus.ie', tag: '免费开源', tags: ['启动盘制作', 'UEFI', '便携'] },
  { id: 'ventoy', name: 'Ventoy', desc: '开源U盘启动盘制作工具，在U盘中创建多个ISO镜像分区，启动时菜单选择要运行哪个系统镜像，无需反复格式化一张U盘，支持Windows、Linux、WinPE等多种系统镜像，新系统体验的便捷工具。', cat: 'system', url: 'https://ventoy.net', tag: '免费开源', tags: ['多系统', '免格式化', '开源'] },
  { id: 'cpu-z', name: 'CPU-Z', desc: '硬件信息检测工具，界面简洁显示CPU、内存、主板和显卡的详细规格参数，包括实时频率、电压、时序等信息，硬件玩家检测配置和跑分对比的必备工具，绿色免安装单文件。', cat: 'system', url: 'https://www.cpuid.com/cpuz', tag: '免费', tags: ['硬件检测', 'CPU信息', '绿色免安装'] },
  { id: 'hwinfo', name: 'HWiNFO', desc: '专业硬件监测和分析工具，提供超过200种传感器实时监控包括温度、风扇转速、电压等，支持历史记录导出和自定义报警阈值，详细报告生成功能是硬件评测和超频玩家的首选诊断工具。', cat: 'system', url: 'https://www.hwinfo.com', tag: '免费', tags: ['传感器监控', '温度', '硬件评测'] },
  { id: 'handbrake', name: 'HandBrake', desc: '开源视频转码工具，支持几乎所有视频格式转换为MP4/MKV，H.265/HEVC编码大幅压缩体积同时保持画质，提供字幕流选择和音轨保留功能，跨平台支持Windows/macOS/Linux，免费替代格式工厂。', cat: 'system', url: 'https://handbrake.fr', tag: '免费开源', tags: ['视频转码', 'HEVC', '格式转换'] },
  { id: 'figma-dev', name: 'Figma Dev Mode', desc: 'Figma面向开发者的功能模式，代码面板直接显示选中元素的CSS、Swift、Kotlin等代码，提供设计标注、间距测量和资产导出功能，减少设计师与开发者之间的沟通成本，提升设计到代码的交付效率。', cat: 'dev', url: 'https://www.figma.com', tag: '免费额度', tags: ['设计开发', '代码标注', 'Dev Mode'] },
  { id: 'shadcn-ui', name: 'shadcn/ui', desc: '基于Radix UI和Tailwind CSS的开源UI组件库，不是npm包而是一组可复制粘贴的代码组件，支持深色模式和无障碍访问，组件设计精美可完全自定义，是现代React项目构建UI的热门选择。', cat: 'dev', url: 'https://ui.shadcn.com', tag: '免费开源', tags: ['React组件', 'Tailwind', '无障碍'] },
  { id: 'lucide', name: 'Lucide', desc: '开源图标库，提供2000+像素完美的SVG图标，支持React、Vue、Svelte等主流框架，图标风格统一简洁，支持按需导入和Tree-shaking，替代Font Awesome成为现代Web项目的首选图标解决方案。', cat: 'dev', url: 'https://lucide.dev', tag: '免费开源', tags: ['SVG图标', '多框架', '按需导入'] },
  { id: 'radix', name: 'Radix UI', desc: '无样式、可访问的React组件库，提供Dialog、Dropdown、Tooltip等基础组件，组件行为和键盘交互完全符合WAI-ARIA标准，可与任何设计系统搭配，是构建无障碍Web应用的组件基础设施。', cat: 'dev', url: 'https://www.radix-ui.com', tag: '免费开源', tags: ['无障碍', 'React', 'WAI-ARIA'] },
  { id: 'zustand', name: 'Zustand', desc: '轻量级React状态管理库，比Redux简单得多，无需Provider包裹，支持React和Preact，中文文档完善，API简洁直观，是中小型React项目状态管理的首选方案，也被用于T3 Stack等现代框架。', cat: 'dev', url: 'https://zustand-demo.pmnd.rs', tag: '免费开源', tags: ['状态管理', 'React', '轻量'] },
  { id: 'biome', name: 'Biome', desc: '一站式前端工具链，合并了Prettier（代码格式化）和ESLint（代码检查）功能，极速启动且内存占用低，支持JS/JSX/TS/JSON等格式，自带opinionated默认配置，大幅简化项目工具链配置。', cat: 'dev', url: 'https://biomejs.dev', tag: '免费开源', tags: ['格式化', 'Lint', '极速'] },
  { id: 'bun', name: 'Bun', desc: '全能JavaScript运行时和工具链，内置打包器、转译器、包管理器，Node.js兼容直接运行现有项目，启动速度和执行效率远超Node，内置TypeScript转译、SQLite数据库和HTTP服务器，现代化开发的一站式解决方案。', cat: 'dev', url: 'https://bun.sh', tag: '免费开源', tags: ['JS运行时', '打包器', '极速'] },
  { id: 'turso', name: 'Turso', desc: '边缘数据库服务，基于LibSQL（SQLite分支）提供全球分布式数据库，支持嵌入式Replica在用户设备本地运行，大幅降低读写延迟，免费额度充足，适合需要边缘部署的全栈应用。', cat: 'dev', url: 'https://turso.tech', tag: '免费额度', tags: ['边缘数据库', 'SQLite', '全球分布'] },
  { id: 'glow', name: 'Glow', desc: 'AI日报生成工具，自动抓取Hacker News、Product Hunt、Twitter等平台热点资讯，AI提炼生成结构化日报，支持自定义关键词过滤和定时推送，RSS和邮件两种接收方式，创业者保持行业敏感度的效率工具。', cat: 'dev', url: 'https://glow.si', tag: '免费', tags: ['AI日报', '热点聚合', '定时推送'] },
  { id: 'regex-vis', name: 'Regex Vis', desc: '正则表达式可视化学习和调试工具，输入正则即可生成语法树和匹配流程图，支持逐节点高亮和分组标记，内置常用正则模板库，是学习和测试正则表达式的直观工具，完全免费在线使用。', cat: 'dev', url: 'https://regex-vis.com', tag: '免费', tags: ['正则调试', '可视化', '学习'] },
]
